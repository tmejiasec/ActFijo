...
public class ProvConverter implements Converter {
 ...
 public ProvConverter() {
    ...
    public Object getAsObject(FacesContext context, UIComponent component, String value) {
        if (value.trim().equals("") || value.trim().equals("Seleccione uno...")) {
            ...
            try {
                ...
                CProveedores prov = getDaoProv().find(id);
                return prov;
            } catch (Exception e) {
    ...
    public String getAsString(FacesContext context, UIComponent component, Object value) {
        if (!(value instanceof CProveedores)) {
            return null;
        }
        return String.valueOf(((CProveedores) value).getCProvId());
    }
     private CProveedoresFacadeLocal getDaoProv() {
